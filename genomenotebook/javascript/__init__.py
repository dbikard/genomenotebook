...
previous_button_code=_get_js_code("previous_button_code.js")
glyph_update_callback_code=_get_js_code("glyph_update_callback_code.js")
attr_callback_code = _get_js_code("attr_callback_code.js")