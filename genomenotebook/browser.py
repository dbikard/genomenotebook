...
# %% auto 0
__all__ = ['GenomeBrowser', 'GenomeStack', 'GenomePlot', 'GenomeBrowserModifier', 'HighlightModifier']
...
def save_html(self:GenomeBrowser, fname:str, title:str="Genome Plot"):
    #bk_output_file(fname, title) # TODO: why do we need to specify this here and in bk_save?
    reset_output()
    bk_output_file(filename=fname, title=title, mode='inline')
    plot = GenomePlot(self)
    bk_save(column(plot.elements))
