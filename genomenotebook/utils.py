...
# %% auto 0
__all__ = ['attributes', 'gene_y_range', 'default_glyphs', 'Y_RANGE', 'parse_gff', 'set_positions', 'get_genome_annotations',
           'extract_attribute', 'extract_all_attributes', 'available_feature_types', 'available_attributes',
           'attributes_to_columns', 'get_features_from_annotation', 'arrow_coordinates', 'box_coordinates',
           'get_patch_coordinates', 'get_feature_patches', 'sort_list_dict', 'get_y_range', 'get_all_glyphs',
