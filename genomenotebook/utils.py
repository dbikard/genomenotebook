...
# %% auto 0
__all__ = ['download_file', 'is_gzipped_file', 'default_open_gz', 'extract_attribute', 'extract_all_attributes',
           'attributes_to_columns', 'set_positions', 'parse_gff', 'available_feature_types', 'available_attributes',
